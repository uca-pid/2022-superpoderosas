...
const Settings = () => {
  ...
  return (
    ...
    <div className="static z-10 flex flex-col space-y-10 min-w-screen pb-10">
        <div className = "z-10 px-10 md:px-20 lg:px-80 basis-1/3 grayBg darkGrayBorder space-y-2 md:space-y-3 lg:space-y-4 py-8 md:py-10 lg:py-16 mt-20">
        ...
        <div className = " px-5 md:px-20 lg:px-80 lg:basis-2/3 flex flex-col lg:flex-row w-full lg:space-x-10 space-y-10 lg:space-y-0">
            <div className="lg:basis-1/2 darkGrayBorder rounded-lg flex flex-col">
                <div className="grayBg darkGrayBottomBorder p-7 blackText font-Pop-M uppercase text-lg md:text-xl tracking-wider font-medium">Perfil de Usuario</div>
                <div className="p-7 flex flex-row space-x-10">
                    <div>
                        <button className="grayDottedBorder lighterGrayBg rounded-xl p-8 px-11 text-3xl font-Pop-M yellowBgHover greenText">+</button>
                    </div>
                    <div className="space-y-3">
                        ...
                        <div className="py-3 px-6 md:px-8 lg:px-10 grayBg rounded-xl tracking-widest font-Pop-M uppercase font-medium text-gray-500 hover:text-white focus:text-white text-[15px] md:text-lg lg:text-lg duration-700 hover:bg-gray-300 focus:bg-gray-300  hover:text-white focus:text-white">Subir Imagen</div>
                    </div>
                </div>
            ...
            <div className="lg:basis-1/2 darkGrayBorder rounded-lg h-fit lg:mb-0">
                <div className="grayBg darkGrayBottomBorder p-7 blackText font-Pop-M uppercase text-lg md:text-xl tracking-wider font-medium">Modificar Cuenta</div>
