...
const LatestActivity = () => {
  return (
    ...
    <div className="border bg-white  rounded-md">
      <div class="px-8 md:px-6 lg:px-8 mb-4 rounded-lg py-5">
        <div class="pb-3 text-sm md:text-base font-Pop-M text-gray-800 border-b border-gray-200">Última Actividad</div>
        <ol className="relative border-l border-gray-400 mt-5 flex flex-col space-y-5">
          {LatestActivityInfo.map((activity) => (
                ...
                <li className="">
                  ...
                  <div class="text-gray-700 flex flex-row items-center justify-between border border-gray-300 rounded-lg py-2 px-2 lg:px-3 ml-3 lg:ml-5">
