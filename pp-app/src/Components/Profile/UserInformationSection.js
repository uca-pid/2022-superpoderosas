...
const UserInformationSection = () => {
  ...
  return (
    <>
    <div className = "flex flex-col md:flex-row z-10 px-6 md:px-32 basis-1/3 bg-[#F6F7F3] border border-[#E3E7DA] py-6 md:py-10 lg:py-8 mt-6 md:mt-14">
        <div className="basis-2/3 flex flex-row space-x-5 md:space-x-10 items-center ">
            <img
                className="object-cover h-24 w-24 md:h-32 md:w-32 rounded "
            ...
            <div className = "flex flex-col justify-center basis-8/10 flex z-10 space-y-1 md:space-y-3 lg:space-y-4 py-1">
                ...
                <div className="z-10 font-Pop-L blackText text-xs md:text-sm break-normal">Me uni a pata pila en el año 2020, para conbatir la desnutrición infantil. Se que toda donación impacta en la salud física y psicologica de cada niño.</div>
            </div>
        </div> 
